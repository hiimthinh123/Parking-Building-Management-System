...
function AdminSidebar() {
    ...
    // 🌟 KHUNG GẦM CYBER NAVY: Tông màu sâu thẳm, tạo độ sang và đồng bộ hệ thống quản trị
    const sidebarStyles = {
        backgroundColor: '#0B0F19', // Xanh đen hoàng gia cực sâu
        width: '240px',
        height: '100vh',
        position: 'fixed',
        top: 0,
        left: 0,
        borderRight: '1px solid #1E293B', // Viền tối mờ đồng bộ
        zIndex: 1000,
        fontSize: '14px',
        boxShadow: '4px 0 24px rgba(0, 0, 0, 0.25)' // Tạo độ sâu tách biệt hoàn toàn với không gian bên phải
    };
    ...
    // 🌟 HIỆU ỨNG CHỌN NÂNG CAO: Chữ sáng khi được chọn, mờ tinh tế khi ở trạng thái chờ
    ...
    return (
        <>
            {/* 🎨 GÓI HACK UI BẰNG CSS SCOPED: Đem lại giao diện lác mắt, đồng bộ toàn hệ thống */}
            <style>{`
                .text-slate-muted { color: #94A3B8 !important; }
                .text-cyan-accent { color: #0EA5E9 !important; }
                
                /* Hiệu ứng trượt màu nhẹ nhàng khi rê chuột vào menu */
                ...
                /* 🌟 Nền của Menu Active: Hiệu ứng ánh kính mờ kết hợp vệt Neon xanh công nghệ */
                .nav-link.active {
                ...
                /* Thanh phát sáng Neon nhỏ ở cạnh viền trái menu đang active */
            ...
            <div className="sidebar d-flex flex-column justify-content-between p-3" style={sidebarStyles}>
                <div className="w-100">
                    ...
                    {/* 1. TIÊU ĐỀ LOGO HỆ THỐNG - Tông xanh dương / trắng bạc phản quang */}
                    ...
                    {/* 2. THÔNG TIN NGƯỜI DÙNG ĐĂNG NHẬP */}
                    <div className="text-center mb-4 px-2 py-3 rounded-3" style={{ background: 'linear-gradient(180deg, #111827 0%, rgba(17,24,39,0) 100%)' }}>
                        <div style={{ fontSize: '11px', letterSpacing: '0.8px', color: '#64748B' }} className="fw-bold text-uppercase">
                            <i className="fa-regular fa-user me-1.5 text-cyan-accent"></i> Xin chào, Admin
                        </div>
                    ...
                    <nav className="nav flex-column mt-2 w-100" style={{ whiteSpace: 'nowrap' }}>
                        ...
                        <NavLink to="/admin/permissions" className={navLinkClass}>
                            {({ isActive }) => (<><i className={iconClass(isActive, 'fa-solid fa-shield-halved')}></i> Phân Quyền Hệ Thống</>)}
                        </NavLink>
                    </nav>
                </div>

                {/* 4. NÚT ĐĂNG XUẤT ĐỒNG BỘ: Viền phát quang Neon hồng nhạt êm ái */}
